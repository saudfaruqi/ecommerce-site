            ...
            <Link href="/products?type=sativa" className="strain-card group block">
              <div className="relative pb-6">
                ...
                <div className="ml-8 space-y-4">
                  ...
                  <p className="text-stone-900 leading-relaxed">Energizing, uplifting, and cerebral effects perfect for daytime use.</p>
            ...
            <Link href="/products?type=indica" className="strain-card group block">
              <div className="relative pb-6">
                ...
                <div className="ml-8 space-y-4">
                  ...
                  <p className="text-stone-900 leading-relaxed">Relaxing, calming, and body-focused effects ideal for evenings.</p>
            ...
            <Link href="/products?type=hybrid" className="strain-card group block">
              <div className="relative pb-6">
                ...
                <div className="ml-8 space-y-4">
                  ...
                  <p className="text-stone-900 leading-relaxed">Balanced blend of both effects for versatile, flexible experiences.</p>
